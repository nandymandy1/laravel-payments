...
class OrderController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $order_id = uniqid();
        $order = new Order();
        $order->order_id = $order_id; //(string)$user_id;
        ...
        // return response()->json([$paytm_txn_url, $paramList, $checkSum]);
    ...
    public function paytmCallback( Request $request ) {
        ...
        if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
                ...
                $order->save();
                return view( 'paytm.order-complete', compact('order', 'status') );
    ...
    */
    function getConfigPaytmSettings() {
            ...
            define('PAYTM_MERCHANT_KEY', '31Q9BhP7U9ddJVip77'); //Change this constant's value with Merchant key downloaded from portal
